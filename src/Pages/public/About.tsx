          ...
          <div className="w-full">
            <div className="grid lg:grid-cols-2 gap-8 xl:gap-12 items-center">
              <motion.div variants={fadeInUp}>
                <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-gray-900 mb-4 xl:mb-6 leading-tight">
                  Travel Agency
                  <span className="block text-2xl sm:text-3xl lg:text-4xl xl:text-5xl text-[#0F8FC6] font-normal">
                    Votre Partenaire Voyage
                  </span>
                </h1>
                <p className="text-lg xl:text-xl text-gray-600 mb-6 xl:mb-8 leading-relaxed">
              ...
              >
                ...
                <motion.div
                  ...
                  className="absolute -bottom-4 -left-4 bg-white/95 backdrop-blur-sm rounded-xl p-4 xl:p-6 shadow-xl"
                >
                  <div className="flex items-center gap-3 xl:gap-4">
                    <div className="w-10 h-10 xl:w-12 xl:h-12 bg-green-100 rounded-full flex items-center justify-center">
                      <Award className="w-5 h-5 xl:w-6 xl:h-6 text-green-600" />
                    </div>
                    <div>
                      <p className="font-bold text-gray-900 text-sm xl:text-base">5000+ Voyageurs</p>
                      <p className="text-xs xl:text-sm text-gray-600">Satisfaits depuis 2010</p>
                    </div>
                  </div>
                </motion.div>
              </motion.div>
        ...
        <div className="w-full">
          ...
          <div className="grid lg:grid-cols-3 gap-8 xl:gap-12">
            <motion.div variants={fadeInUp} className="text-center">
              <div className="w-16 h-16 xl:w-20 xl:h-20 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4 xl:mb-6">
                <Compass className="w-8 h-8 xl:w-10 xl:h-10 text-[#0F8FC6]" />
              </div>
              <h3 className="text-xl xl:text-2xl font-bold text-gray-900 mb-3 xl:mb-4">Expertise Locale</h3>
            ...
            <motion.div variants={fadeInUp} className="text-center">
              <div className="w-16 h-16 xl:w-20 xl:h-20 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4 xl:mb-6">
                <Shield className="w-8 h-8 xl:w-10 xl:h-10 text-green-600" />
              </div>
              <h3 className="text-xl xl:text-2xl font-bold text-gray-900 mb-3 xl:mb-4">Voyages Sécurisés</h3>
              <p className="text-base xl:text-lg text-gray-600 leading-relaxed">
            ...
            <motion.div variants={fadeInUp} className="text-center">
              <div className="w-16 h-16 xl:w-20 xl:h-20 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4 xl:mb-6">
                <Heart className="w-8 h-8 xl:w-10 xl:h-10 text-purple-600" />
              </div>
              <h3 className="text-xl xl:text-2xl font-bold text-gray-900 mb-3 xl:mb-4">Service Personnalisé</h3>
              <p className="text-base xl:text-lg text-gray-600 leading-relaxed">
