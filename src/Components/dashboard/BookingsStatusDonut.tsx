...
const STATUS_CONFIG = {
  ...
  CONFIRMED: { color: '#10b981', label: 'Confirmé' },
  COMPLETED: { color: '#2563eb', label: 'Terminé' },
...
export const BookingsStatusDonut: React.FC<BookingsStatusDonutProps> = ({ data }) => {
  ...
  return (
    ...
    >
      <h3 className="text-lg font-bold text-gray-800 dark:text-white mb-4">📊 Répartition des Réservations</h3>
