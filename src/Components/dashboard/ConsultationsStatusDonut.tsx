...
interface ConsultationsStatusDonutProps {
  data: Array<{ status: string; count: number; percentage: number }>;
}

export const ConsultationsStatusDonut: React.FC<ConsultationsStatusDonutProps> = ({ data }) => {
  ...
  return (
    ...
    >
      <h3 className="text-lg font-bold text-gray-800 dark:text-white mb-4">
        💬 {t('agentDashboard.charts.consultationsStatus')}
      </h3>
        ...
        <PieChart>
          ...
          <Tooltip
            ...
            formatter={(value: number, name: string, props: any) => [
              `${value} consultations (${props.payload.percentage.toFixed(1)}%)`,
              name,
            ]}
          />
